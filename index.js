(function(global, factory) {
  ...
  var script$2 = {
    ...
    methods: {
      ...
      getYearBE: function getYearBE(data) {
        if (data.panel === 'year' && this.lang === 'th') {
          return ''.concat(Number(data.label) + 543);
        }
  ...
  var script$3 = {
    ...
    computed: {
      calendarYear: function calendarYear() {
        var currentYear = this.calendar.getFullYear();
  ...
  var DatePicker = {
    ...
    methods: {
      ...
      formatDate: function formatDate(date, fmt) {
        ...
        if (this.lang === 'th' && ''.concat(fmt).includes('YYYY')) {
          var fmtBE = ''.concat(fmt).replace('YYYY', 'BBBB');
          var defaultDateFormat = format(date, fmtBE, {
            locale: this.locale.formatLocale,
          });
          var currentYearCE = new Date(date).getFullYear();
