!(function(e, t) {
  ...
  var A = /(\[[^\[]*\])|(MM?M?M?|Do|DD?|ddd?d?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|S{1,3}|x|X|ZZ?|.)/g,
    F = /\d/,
    P = /\d\d/,
    $ = /\d\d?/,
    j = /[+-]?\d+/,
  ...
  function R(e, t) {
    ...
    try {
      ...
      return (
        void 0 !== h
          ? ((D[6] += 60 * h * 1e3), (m = B.apply(void 0, T(D))))
    ...
    be = he(
      ...
      void 0,
      {
        ...
        props: {
          ...
          lang: { type: [String, Object], default: 'en' },
        },
        computed: {
        ...
        methods: {
          ...
          getYearBE: function(e) {
            return 'year' === e.panel && 'th' === this.lang
              ? ''.concat(Number(e.label) + 543)
              : e.label;
          },
        },
      },
    ...
    Ce = he(
                    ...
                    return t(
                      ...
                      e._l(n, function(n, a) {
                        return t(
                          ...
                          [t('div', 'th' === e.lang ? [e._v(e._s(n + 543))] : [e._v(e._s(n))])]
                        );
                      }),
                      0
                    );
      ...
      void 0,
      {
        ...
        computed: {
          ...
          firstYear: function() {
            return 'th' === this.lang ? this.years[0][0] + 543 : this.years[0][0];
          },
          lastYear: function() {
            var e = function(e) {
              return e[e.length - 1];
            };
            return 'th' === this.lang ? e(e(this.years)) + 543 : e(e(this.years));
          },
        },
        methods: {
          isDisabledArrows: function(e) {
  ...
  var Oe = he(
    ...
    Pe = {
      ...
      inject: { prefixClass: { default: 'mx' } },
      emits: ['select', 'update:show-time-panel'],
      props: r({}, Se.props, {}, Ae.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
        return { defaultTimeVisible: !1, currentValue: this.value };
      },
      computed: {
      ...
      render: function() {
        ...
        return e('div', [
          e(Se, f([{}, t])),
          this.timeVisible && e(Ae, f([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    $e = { default: we, time: _e, datetime: Fe },
    je = { default: Se, time: Ae, datetime: Pe },
    Ie = {
      name: 'DatePicker',
      provide: function() {
        var e = this;
      ...
      methods: {
        ...
        parseDate: function(e, t) {
          ...
          var n = new Date();
          return R(e, t, { locale: this.locale.formatLocale, backupDate: n });
        },
        formatDate: function(e, t) {
          if (((t = t || this.innerFormat), 'function' == typeof this.getFormatter('stringify')))
            return this.getFormatter('stringify')(e, t);
          if ('th' === this.lang && ''.concat(t).includes('YYYY')) {
            var n = x(e, ''.concat(t).replace('YYYY', 'BBBB'), {
                locale: this.locale.formatLocale,
              }),
              a = new Date(e).getFullYear();
            return n.replace('BBBB', a + 543);
          }
          return x(e, t, { locale: this.locale.formatLocale });
        },
